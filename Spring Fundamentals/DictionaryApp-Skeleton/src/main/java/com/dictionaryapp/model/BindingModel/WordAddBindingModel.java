package com.dictionaryapp.model.BindingModel;
...
public class WordAddBindingModel {
    ...
    @Size(min = 2, max = 40, message = "Term length must be between 2 and 40 character!")
    private String term;

    @Size(min = 2, max = 80, message = "Translation length must be between 2 and 80 character!")
    private String translation;

    @Size(min = 2, max = 200, message = "Example length must be between 2 and 200 character!")
